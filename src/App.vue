...
<template>
  <div class="app-container">
    <!-- Header y Nav siempre visibles -->
    <div class="container-fluid">
      <div class="row bg-light py-3 mb-4">
        <header class="col-12 text-center mb-0">
          <h1 class="headerTitle">Implementacion Web con Bootstrap</h1>
        </header>
        <nav class="col-12">
          <ul class="nav justify-content-center">
            <li class="nav-item"><router-link to="/home" class="nav-link">Inicio</router-link></li>
            <li class="nav-item"><router-link to="/information" class="nav-link">Informacion</router-link></li>
